...
def get_hand_state(robot: H1Robot, arm: ArmAction):
    """
    兼容两种绑定签名:
...
def print_hand_state(robot: H1Robot):
...
def main():
    ...
    try:
        # 实例化机器人
        robot = H1Robot("10.20.0.61")   #SDK运行环境为用户主机，无线连接方式，ip不固定
